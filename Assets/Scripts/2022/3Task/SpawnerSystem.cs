	...
	public partial struct SpawnerSystem : ISystem
	{
		...
		public void OnUpdate(ref SystemState state)
		{
			if (!spawned)
			{
				...
				SpawnPrefabs(ref state, spawnerAspect);
				spawned = true;
			}
			else
			{
				AnimateColors(ref state);
			}
		}

		private void SpawnPrefabs(ref SystemState state, SpawnerAspect spawnerAspect)
		{
		...
		private void AnimateColors(ref SystemState state)
		{
